...
* [Models Used](#3-models)
  ...
  * [MaskRCNN](#32-maskrcnn)
    * [Components](#321-components)
      * [CustomBackbone](#custombackbone)
      * [FeaturePyramidNetwork](#featurepyramidnetwork)
      * [PyramidRoIAlign](#pyramidroialign)
      * [SemanticLaneHead](#semanticlanehead)
      * [LaneDetectionModel](#lanedetectionmodel)
  ...
  * [Faster R-CNN with ResNet50-FPN](#33-faster-r-cnn-with-resnet50-fpn)
    ...
    * [Loss Functions](#335-loss-functions)
      ...
      * [Bounding Box Regression Loss](#bounding-box-regression-loss)
      * [Objectness Loss](#objectness-loss)
      * [Combined Loss Function](#combined-loss-function)
    * [Evaluation Metrics](#336-evaluation-metrics)
      * [Accuracy](#accuracy)
...
* [Challenges](#6-challenges)
  * [Exploding Gradients](#61-exploding-gradients)
  * [Predictions Positioning](#62-predictions-positioning)
* [Transfer Learning](#7-transfer-learning)
  * [Introduction To Transfer Learning](#71-introduction-to-transfer-learning)
  * [Application of Transfer Learning](#72-application-of-transfer-learning-in-this-project)
  * [Transfer Learning Code](#73-transfer-learning-code)
* [Models Comparison](#8-models-comparison)
  * [MaskRCNN](#81-maskrcnn)
  * [LaneNET](#82-lanenet)
* [Validation With Our Own Images](#9-validation-with-our-own-images)
* [Validation With Youtube Videos](#10-validation-with-youtube-videos)
